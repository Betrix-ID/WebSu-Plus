...
public interface PathDirName {

		interface folder {
				String ROOT = "/";
				String SHELL = "data/user_de/0/com.android.shell/";
				String PARENT = "WebSu/";
				String PLUGIN = "webui/";
				String PLUGIN_UPDATE = "webui_update/";
				String CACHE = "cache/";
				String LOG = "logs/";
				String BINARY = "vbin/";
				String EXTERNAL_BINARY = "system/sbin/";
				String ZIP = "zip/";
                ...
                String PATH_UNZIP = SHELL_ROOT + PARENT_PLUGIN;
			}
